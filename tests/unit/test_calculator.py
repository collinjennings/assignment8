...
@pytest.mark.parametrize(
    ...
    [
        ...
        (5.5, 2.0, 1.5),     # Test modulus of a positive float and a positive integer
        (-5.5, 2.0, 0.5),    # Test modulus of a negative float and a positive integer
    ],
    ids=[
        "modulus_two_positive_integers",
        "modulus_negative_integer_and_positive_integer",
        "modulus_positive_float_and_positive_integer",
        "modulus_negative_float_and_positive_integer",
    ]
)
def test_modulus(a: Number, b: Number, expected: Number) -> None:   
    ...
    >>> test_modulus(-5, 2, 1)
    """
    # Import modulus function here to avoid circular imports if any
